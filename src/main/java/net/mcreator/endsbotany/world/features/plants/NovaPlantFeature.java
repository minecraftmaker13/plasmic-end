...
package net.mcreator.endsbotany.world.features.plants;
...
public class NovaPlantFeature extends RandomPatchFeature {
	...
	public static Feature<?> feature() {
		...
		PLACED_FEATURE = PlacementUtils.register("ends_botany:nova_plant", CONFIGURED_FEATURE, List.of(CountPlacement.of(5),
